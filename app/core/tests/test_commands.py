...
# One of possibilites we can get
# trying to connect to the db before db get ready

from django.core.management import call_command
# call_command enables to call commands
from django.db.utils import OperationalError
# One of possibilites we can get trying to
# connect to the db before db get ready
